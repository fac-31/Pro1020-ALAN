...
def create_email_connection_error(
    message: str = "Failed to connect to email service",
) -> EmailServiceError:
...
def create_content_evaluation_error(
    message: str = "Content evaluation failed",
...
def create_not_found_error(
    ...
    return NotFoundError(
        message=f"{resource} not found", error_code="NOT_FOUND", details=details
    )
