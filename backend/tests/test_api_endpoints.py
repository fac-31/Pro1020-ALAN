...
class TestAPIEndpoints(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch.dict(
            ...
            # Mock all services
            with patch("main.initialize_email_client") as mock_init_email, patch(
                "main.RAGEngine"
            ) as mock_rag, patch("main.AIService") as mock_ai, patch(
                "main.DailyDigestService"
            ) as mock_digest:
    ...
    def test_processed_messages_endpoint(self):
        ...
        # Mock processed IDs
        app.state.email_client.load_processed_ids.return_value = [
            "msg1",
            "msg2",
            "msg3",
        ]
    ...
    def test_subscriber_endpoints(self):
        ...
        data = response.json()
        self.assertEqual(
            data["message"], "Successfully subscribed to Alan's daily digest"
        )
        self.assertTrue(data["success"])
