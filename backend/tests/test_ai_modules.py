...
class TestConversationMemory(unittest.TestCase):
    ...
    def test_add_and_get_messages(self):
        ...
        # Add messages
        self.memory.add_message('user@example.com', 'incoming', 'Hello Alan', 'Greeting')
    ...
    def test_conversation_history_limit(self):
        ...
        for i in range(10):
            self.memory.add_message('user@example.com', 'incoming', f'Message {i}', f'Subject {i}')
    ...
    def test_multiple_users(self):
        ...
        self.memory.add_message('user1@example.com', 'incoming', 'Hello from user1', 'Subject1')
        self.memory.add_message('user2@example.com', 'incoming', 'Hello from user2', 'Subject2')
