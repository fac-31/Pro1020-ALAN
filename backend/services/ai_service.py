...
class AIService:
    ...
    def _setup_langsmith_tracking(self):
        ...
        if settings.langsmith_api_key:
            try:
                ...
                project_name = (
                    settings.langsmith_project_email or settings.langsmith_project
                )
    ...
    def generate_welcome_email(
        self, user_name: str, user_email: str, interests: List[str]
    ) -> str:
    ...
    def _create_system_prompt(
        self, user_interests: List[str] = None, context: str = None
    ) -> str:
        ...
        if (
            context
            and context != "No relevant information found in the knowledge base."
        ):
    ...
    async def generate_text(self, system_prompt: str, human_message: str, response_format: str = None) -> str:
        ...
        try:
            ...
            if response_format == "json":
                llm_to_use = self.llm.bind(response_format={"type": "json_object"})
            ...
            raise create_openai_error(f"Failed to generate text: {str(e)}")
